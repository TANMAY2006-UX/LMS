...
def seed_categories():
    """Injects standard Library Categories into the database."""
    with app.app_context():
        ...
        categories = [
            ...
            Category(name="Science & Mathematics", slug="science-math"),
            Category(name="Business & Economics", slug="business-economics"),
            Category(name="History & Geography", slug="history-geography"),
            Category(name="Fiction & Literature", slug="fiction-literature"),
            Category(name="Philosophy & Psychology", slug="philosophy-psychology"),
            Category(name="Self-Help", slug="self-help"),
        ]
        
        db.session.add_all(categories)
        db.session.commit()
        print("✅ Successfully seeded 8 Categories into PostgreSQL!")
